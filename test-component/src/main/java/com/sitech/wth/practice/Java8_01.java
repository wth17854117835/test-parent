...
//        LocalDateTime end = LocalDateTime.parse("2020-08-07 14:21:26", dateTimeFormatter);
...
//        System.out.println("【 "+days+"天："+hours+" 小时："+minutes+" 分钟："+millis+" 毫秒："+nanos+" 纳秒】");
...
//        System.out.println("获取Clock时区的时间为"+localDateTime1);
        LocalDate localDate = LocalDate.parse("2021-09-15", DateTimeFormatter.ofPattern("yyyy-MM-dd"));
        System.out.println(DateTimeFormatter.ofPattern("yyyyMMdd").format(localDate));
        LocalDateTime localDateTime = LocalDateTime.parse("2021-09-15 10:53:30", DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss")); //2020-08-07T14:21:26
        System.out.println(DateTimeFormatter.ofPattern("yyyyMMdd HHmmss").format(localDateTime));
